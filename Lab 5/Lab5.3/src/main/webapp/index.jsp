...
<div class="root">
    <div class="content">
        ...
        <div class="input1">
            ...
            <input onblur="validate_of_Name_Blur()" oninput="validate_of_Name_onInput()" class="inputName" type="text" placeholder="Full Name">
            <div class="lineUp"></div>
        </div>
        <span class="errorFullName"></span>
        <div class="input2">
            <i class="fa-solid fa-envelope" style="color: #b7b9c2;"></i>
            <input onblur="validate_of_Email_Blur()" oninput="validate_of_Email_onInput()"  class="inputEmail" type="text" placeholder="Email Adress">
        ...
        <div class="input3">
            ...
            <input oninput="validate_of_Pass_onInput()" onblur="validate_of_Pass_Blur()" class="inputPassword" type="password" placeholder="Password">
