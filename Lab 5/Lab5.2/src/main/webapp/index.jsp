...
<div class="root">
  ...
  <div class="content">
   <div class="title">
    ...
    <input onblur="validate_of_Name_Blur()" oninput="validate_of_Name_onInput()"  class="userNameInput" type="text" placeholder="username or email" style="color: hsl(294.29deg 43.38% 26.05%)">
    <span class="username_or_email"></span>
    <input onblur="validate_of_Pass_Blur()" oninput="validate_of_Pass_onInput()" class="password" type="password" placeholder="password" style="color: hsl(294.29deg 43.38% 26.05%)">
